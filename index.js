...
//GENERATE LOVE LETTER
  ...
  function getRandomLetter(newLetter){
    ...
    quotesArray.splice(randomQuote, 1);
  }
...
const quotesArray = [
  ...
  <br> -- Alexis Pauline Gumbs :: "<a href="https://topicalcream.org/features/the-god-of-every-day/" target="_blank">The God of Every Day</a>"`,
  ...
  <br> -- Awkwaeke Emezi :: "<i>Dear Senthuran: Black Spirit Memoir</i>", Execution | Dear Nonso`,
                
  `“Sometimes we don't get the reassurances we want; we make the work anyway.”
  
  <br> -- Awkwaeke Emezi :: "<i>Dear Senthuran: Black Spirit Memoir</i>", Canon | Dear Daniel`,

  `“First forget inspiration. Habit is more dependable. Habit will sustain you whether you’re inspired or not. Habit will help you finish and polish your stories. Inspiration won’t. Habit is persistence in practice.”
  
  <br> -- Octavia Butler :: <i>Bloodchild and Other Stories</i>, Furor Scribendi`,
  ...
  <br> -- Audre Lorde :: Oberlin College May 29, 1989`,
  ...
  <br> -- Alexis Pauline Gumbs :: "<i>Undrowned</i>", Honor your Boundaries`,

  `“Our fear may not go away, but it will not stand in the way”
  
  <br> -- bell hooks :: pulled from <a href="https://www.seedaschool.com/program" target="_blank">Seed a World</a> Affirmations`,

  `“The moment we choose to love, we begin to move against domination, against oppression. The moment we choose to love we begin to move towards freedom, to act in ways that liberate ourselves and others. That action is the testimony of love as the practice of freedom”
  
  <br> -- bell hooks :: Love as the Practice of Freedom`,
  ...
  <br> -- Alexis Pauline Gumbs :: "<i>Undrowned</i>", Learn from Conflict`,
  ...
  <br> -- Ayana Zaire Cotton :: "<a href="https://open.substack.com/pub/seedaschool/p/practice-doesnt-make-perfect-it-makes?r=aayhw&utm_campaign=post&utm_medium=web" target="_blank">Practice Doesn’t Make Perfect, It Makes Possibility</a>"` 
]
...
function dragElement(elmnt) {
  ...
  function dragMouseDown(e) {
    ...
    // Bring the element to the front when drag starts
    bringToFront(elmnt);
  }
